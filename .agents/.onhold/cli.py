...
def _root(
    ...
    """zero: link raw 'zero' paths into a single source."""
    return
...
@app.command("alias")
def print_alias() -> None:
    """Print copy/paste alias command for PowerShell."""
    ps = "Set-Alias -Name zero -Value \"$env:LOCALAPPDATA\\zerolink\\Scripts\\zero.exe\""
